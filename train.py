...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System" ,bg="Orange"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
copyWrite = tk.Text(window, background=window.cget("background"), borderwidth=0,font=('times', 30))
copyWrite.tag_configure("superscript", offset=10)
copyWrite.insert("insert", "Developed by Team Debuggerz")
copyWrite.configure(state="disabled",fg="light blue"  )
